...
public class ServiceFeedbackFragment extends Fragment {
    ...
    public static ServiceFeedbackFragment newInstance(String param1, String param2) {
    ...
    public ServiceFeedbackFragment() {
            ...
            {Reader reader = new InputStreamReader(is);
                ...
                if (posts != null && running)
                    for (int i = 0; i < posts.size(); ++i) {
                        ...
                        ServiceFeedbackCard card = new ServiceFeedbackCard(getActivity().getApplicationContext(),a.stars,a.description,a.name);
                        cards.add(card);
                    }
...
class ServiceFeedbackCard extends Card {
    int stars;
